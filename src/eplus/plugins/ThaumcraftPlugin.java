...
public class ThaumcraftPlugin {
    ...
    public void PreInit() {
        ...
        toolTips.put("enchantment.haste", "Usable on boots and the Thaumostatic Harness only. Makes you move faster. Very effective on Boots of the Traveller, or the Thaumostatic Harness.");
