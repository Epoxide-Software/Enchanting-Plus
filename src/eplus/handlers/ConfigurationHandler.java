...
public class ConfigurationHandler
{
    ...
    public static void init(File suggestedConfigurationFile)
    {
        ...
        try {
            ...
            ConfigurationSettings.useMod = configuration.get(CATEGORY_BOTH,
                    "useMod",
            ...
            ConfigurationSettings.needsBookShelves = configuration.get(CATEGORY_SERVER,
                    "needsBookShelves",
            ...
            ConfigurationSettings.hasLight = configuration.get(CATEGORY_SERVER,
                    "hasLight",
                    ConfigurationSettings.lightDefault,
                    "Set to true to have the enchanting table emmit light.")
                    .getBoolean(ConfigurationSettings.lightDefault);
            ConfigurationSettings.hasParticles = configuration.get(CATEGORY_CLIENT,
                    "hasParticles",
            ...
            ConfigurationSettings.AllowDisenchanting = configuration.get(CATEGORY_SERVER,
                    "AllowDisenchanting",
            ...
            ConfigurationSettings.AllowRepair = configuration.get(CATEGORY_SERVER,
                    "AllowRepair",
