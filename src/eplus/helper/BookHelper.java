...
public class BookHelper {
     ...
     */
    public static void addEnchantmentData(ItemStack itemStack,
                                          EnchantmentData enchantmentData)
    {
            ...
            if (nbttagcompound.getShort("id") == enchantmentData.enchantmentobj.effectId) {
                if (nbttagcompound.getShort("lvl") != enchantmentData.enchantmentLevel) {
                    nbttagcompound.setShort("lvl",
                            (short) enchantmentData.enchantmentLevel);
                }
        ...
        if (flag) {
            ...
            nbttagcompound1.setShort("id",
                    (short) enchantmentData.enchantmentobj.effectId);
    ...
    public static NBTTagList getTag(ItemStack par1ItemStack)
    {
        return par1ItemStack.stackTagCompound != null
                && par1ItemStack.stackTagCompound.hasKey("StoredEnchantments") ? (NBTTagList) par1ItemStack.stackTagCompound
