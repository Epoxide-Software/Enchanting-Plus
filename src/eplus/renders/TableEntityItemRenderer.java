...
public class TableEntityItemRenderer extends Render
{
    ...
    public TableEntityItemRenderer()
    {
    ...
    public void doRenderItem(EntityItem par1EntityItem, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        if (itemstack.getItem() != null) {
            ...
            if (ForgeHooksClient.renderEntityItem(par1EntityItem,
                    itemstack,
                    f2,
                    f3,
                    random,
                    ...
                    renderBlocks)) {
                ;
            } else if (itemstack.getItemSpriteNumber() == 0 && block != null && RenderBlocks.renderItemIn3d(Block.blocksList[itemstack.itemID]
                    .getRenderType())) {
    ...
    private void renderDroppedItem(EntityItem par1EntityItem, Icon par2Icon, int par3, float par4, float par5, float par6, float par7)
    {
        ...
        if (renderInFrame) {
            ...
            GL11.glRotatef((((float) par1EntityItem.age + par4) / 20.0F + par1EntityItem.hoverStart) * (180F / (float) Math.PI),
                    0.0F,
                    1.0F,
                    0.0F);
        }
        ...
        for (int k = 0; k < b0; ++k) {
            ...
            ItemRenderer.renderItemIn2D(tessellator,
                    ...
                    f4,
                    f7,
                    par2Icon.getSheetWidth(),
                    par2Icon.getSheetHeight(),
                    f12);
    ...
    public void renderItemIntoGUI(FontRenderer par1FontRenderer, RenderEngine par2RenderEngine, ItemStack par3ItemStack, int par4, int par5)
    {
        ...
        if (par3ItemStack.getItemSpriteNumber() == 0 && block != null && RenderBlocks.renderItemIn3d(Block.blocksList[k]
                .getRenderType())) {
    ...
    public void renderItemStack(FontRenderer par1FontRenderer, RenderEngine par2RenderEngine, ItemStack par3ItemStack, int par4, int par5, String par6Str)
    {
        if (par3ItemStack != null) {
            if (par3ItemStack.stackSize > 1 || par6Str != null) {
                ...
                par1FontRenderer.drawStringWithShadow(s1,
            ...
            if (par3ItemStack.isItemDamaged()) {
                int k = (int) Math.round(13.0D - (double) par3ItemStack.getItemDamageForDisplay() * 13.0D / (double) par3ItemStack
                        .getMaxDamage());
                int l = (int) Math.round(255.0D - (double) par3ItemStack.getItemDamageForDisplay() * 255.0D / (double) par3ItemStack
                        .getMaxDamage());
                GL11.glDisable(GL11.GL_LIGHTING);
                GL11.glDisable(GL11.GL_DEPTH_TEST);
