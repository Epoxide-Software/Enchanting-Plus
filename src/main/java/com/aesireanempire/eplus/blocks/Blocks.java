...
public class Blocks
{
    ...
    public static void init()
    {
        ...
        CraftingManager.getInstance().addRecipe(new ItemStack(table), "gbg", "oto", "geg", 'b', Items.writable_book, 'o', net.minecraft.init.Blocks.obsidian, 't', net.minecraft.init.Blocks.enchanting_table, 'e', Items.ender_eye, 'g', Items.gold_ingot);
