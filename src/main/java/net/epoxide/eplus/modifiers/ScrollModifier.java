...
public class ScrollModifier {
     ...
     *            ID and meta as this one is added to the inscription process, this modifier
     *            will be applied.
     * @param stability: The amount of stability that this modifier will bring to the
     *            inscription process. The float represents a direct percentage, where 0.05 is
     *            5% stability. Stability is used to calculate whether or not the process will
     *            fail. You can also use a negative float, to reduce stability.
     * @param speed: The amount of speed which this modifier will add to the recipe. Progress
     *            is handled by a float, where 0.0 is 0% complete, and 1.0 is 100% complete.
     *            Every update, the speed float will be added to the recipe progression float.
     *            You can use a negative float to make the recipe slower.
     * @param handleInscriptions: A flag to enable/disable the onInscription method. If you
     *            have no need for the method, this can be set to false, which will save the
     *            user a negligible amount of cpu and memory.
     */
