...
//        final int indexX = this.dragging ? (int)this.sliderValue : ((int)this.sliderValue) <= this.enchantment.getMaxLevel() ? (int) (this.x + 1 + (this.width - 6) * ( ((int)this.sliderValue) / (double) this.enchantment.getMaxLevel())) : this.x + 1 + this.width - 6;
        
        drawRect(x+(int)sliderValue, this.x + 1, x+(int)sliderValue + 5, this.y - 1 + this.height, 0xff000000);
